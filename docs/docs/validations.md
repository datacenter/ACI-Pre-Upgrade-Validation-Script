...
2. Upload the image from your desktop or FTP server onto one of the Cisco APICs.
   ...
   See the _Downloading APIC and Switch Images on APICs_ section in the ACI Upgrade Guide for instructions on performing this operation on the Cisco APICs:
...
After release 6.0, per-leaf fabric uplink count is enforced. If a leaf switch has surpassed 56 uplinks and is upgraded, 56 uplinks will come up and the rest will not.
