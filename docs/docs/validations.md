...
To avoid this issue, modify user VLAN pool ranges so that the InfraVLAN does not overlap with any configured block or select target fixed version 6.2(2e) or above.
