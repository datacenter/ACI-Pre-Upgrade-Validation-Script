...
| APIC SSD Health                                                                            | Check APIC SSD lifetime from AE log `grep -oE "SSD Wearout Indicator is [0-9]+" /var/log/dme/log/svc_ifc_ae.bin.log` | SSD health status on APICs |
